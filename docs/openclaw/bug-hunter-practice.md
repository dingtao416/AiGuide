...
每周后端/服务端都会收到一批来自 **代码审查平台** 的工单，内容是代码审查机器人发现的安全隐患，例如：
...
> 💡 由于平台进行了一次性扫描，发现了很多的历史遗留问题（总数超 100 个），这类 Bug **数量多、规律强、重复度高**，人工处理费时费力，非常适合用 AI 做自动化处理。

### 2.2 解决方案

使用**「拉工单 → 修代码 → AI Review → 提交审核 → 代码提交」** 的全流程自动化方案进行自动化处理
...
| 第三篇     | 🎯 多Agent三方沙盘会 | [查看](./multi-agent-sandbox-meeting.md) |
