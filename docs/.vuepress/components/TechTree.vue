<template>
  <div class="tech-tree-section" :class="{ dark: isDark }">
    ...
    <div class="tree-container" ref="treeRef">
      ...
      <div class="tree-nodes">
        ...
        >
          ...
          <div class="node-sub" v-if="activeNode === index || hoverNode === index">
            {{ node.desc }}
          </div>
        </div>
      </div>
    ...
    <div class="hot-articles">
      ...
      <div class="hot-grid">
        <a v-for="(a, i) in hotArticles" :key="i" :href="a.link" class="hot-card">
...
const nodes = [
  ...
  { icon: '🧠', label: '模型入门', desc: 'GPT/Claude/Gemini 等主流模型', level: 1, col: '1', row: '2', color: 'rgba(59,130,246,0.3)' },
  { icon: '🎨', label: '多模态', desc: '图像/视频/音频/3D 创作', level: 1, col: '3', row: '2', color: 'rgba(236,72,153,0.3)' },
  { icon: '🤖', label: 'Agent', desc: 'MCP/SKILL/RULES 智能体开发', level: 1, col: '5', row: '2', color: 'rgba(34,197,94,0.3)' },
  { icon: '🚀', label: '实战场景', desc: 'AI写作/漫剧/视频/自动化', level: 2, col: '2', row: '3', color: 'rgba(251,146,60,0.3)' },
  { icon: '🛠️', label: '工具平台', desc: 'Dify/Coze/Cursor 等开发工具', level: 2, col: '4', row: '3', color: 'rgba(14,165,233,0.3)' },
]

const hotArticles = [
  { title: 'GPT-4o 多模态详解', link: '/models-intro/gpt-family/gpt-4o.html', tag: '模型' },
  { title: 'MCP 协议完整指南', link: '/ai-agents/mcp-protocol/mcp-overview.html', tag: 'Agent' },
  { title: 'Midjourney 从入门到精通', link: '/multimodal-ai/image-ai/image-generation/midjourney.html', tag: '多模态' },
  { title: 'Spec Coding 新范式', link: '/practical-scenarios/content-creation/ai-writing/spec-coding.html', tag: '实战' },
  { title: 'Cursor AI 编程助手', link: '/tools-platforms/development-tools/cursor-ai.html', tag: '工具' },
  { title: 'SKILL 技能系统解析', link: '/ai-agents/skill-systems/skill-fundamentals.html', tag: 'Agent' },
]
...
@media (max-width: 768px) {
  ...
  .tree-node { grid-column: auto !important; grid-row: auto !important; }
}
</style>